...
export class PanelStockGeneralByAlmacenComponent implements OnInit, OnDestroy {
  ...
  loadWarehouse() {
    ...
    .subscribe({
      ...
      error: e => {
        this.utilService.handleErrorSingle(e,'loadWarehouse',() => {this.isDisplay = false},this.swaCustomService);
      }
    });
  }
  ...
  loadData() {
    ...
    this.ArticuloService.getListStockGeneralSummary(params)
    .pipe(
      takeUntil(this.destroy$),
      finalize(() => {
  ...
  onToExcel() {
    ...
    this.ArticuloService.getStockGeneralSummaryExcel(params)
    ...
    .subscribe({
      ...
      error: e => {
        this.utilService.handleErrorSingle(e, 'getStockGeneralByAlmacenExcel', () => (this.isDisplay = false), this.swaCustomService);
      }
    });
  }
