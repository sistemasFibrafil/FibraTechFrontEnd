...
export interface IInventoryTransferRequest {
  ...
  jrnlMemo            : string;
  comments            : string;
  lines               : IInventoryTransferRequestLines[];
  pickingLines        : IPicking[];
}

export interface IInventoryTransferRequestLines {
  objType?        : string;
  docEntry?       : number;
  lineNum?        : number;
  baseType?       : number;
...
export interface IInventoryTransferRequestQuery {
  docEntry            : number;
  docNum              : number;
  docStatus           : string;
  docDate             : Date;
  ...
  jrnlMemo            : string;
  comments            : string;
  lines               : IInventoryTransferRequestLinesQuery[];
  pickingLines        : IPicking[];
}

export interface IInventoryTransferRequestLinesQuery {
  objType?        : string;
  docEntry?       : number;
  lineNum?        : number;
  baseType?       : number;
