...
@Component({
  selector: 'app-ven-panel-factura-reserva-view',
  templateUrl: './panel-factura-reserva-view.component.html',
  styleUrls: ['./panel-factura-reserva-view.component.css']
})
export class PanelFacturaReservaViewComponent implements OnInit, OnDestroy {
    ...
    .subscribe({
      next: (fullAddress: string | null) => {
        if (fullAddress !== null && fullAddress !== undefined) {
          ...
          this.modeloFormLog.patchValue({ address: fullAddress }, { emitEvent: false });
        }
      },
      error: (e) => {
