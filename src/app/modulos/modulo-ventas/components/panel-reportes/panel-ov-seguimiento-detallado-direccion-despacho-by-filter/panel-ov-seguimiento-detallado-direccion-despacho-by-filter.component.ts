...
@Component({
  selector: 'app-ven-panel-ov-seguimiento-detallado-direccion-despacho-by-filter',
  templateUrl: './panel-ov-seguimiento-detallado-direccion-despacho-by-filter.component.html',
  styleUrls: ['./panel-ov-seguimiento-detallado-direccion-despacho-by-filter.component.css']
})
export class PanelOrdenVentaSeguimientoDetalladoDirecionDespachoByFilterComponent implements OnInit {
  modeloForm: FormGroup;
  modeloFormSop: FormGroup;

  // Titulo del componente
  titulo = 'OV - Seguimiento Detallado - Dirección Despacho';
  subtitulo = 'OV - Seguimiento Detallado - Dirección Despacho';
  // Acceso de botones
  ...
  onBuildForm() {
    ...
    this.buttonAcces = this.accesoOpcionesService.getObtieneOpciones('app-ven-panel-ov-seguimiento-detallado-direccion-despacho-by-filter');
  }
  ...
  onListar() {
    this.isDisplay = true;
    this.onSetParametro();
    this.OrdenVentaService.getListSeguimientoDetalladoDireccionDespachoByFilter(this.params)
  ...
  onClickExcel() {
    this.isDisplay = true;
    this.onSetParametro();
    this.OrdenVentaService.getSeguimientoDetalladoDireccionDespachoByFilterExcel(this.params)
