...
@Component({
  selector: 'app-ven-panel-ov-detallado-direccion-despacho',
  templateUrl: './panel-ov-detallado-direccion-despacho.component.html',
  styleUrls: ['./panel-ov-detallado-direccion-despacho.component.css']
})
export class PanelOrdenVentaDetalladoDirecionDespachoComponent implements OnInit {
  ...
  onBuildForm() {
    ...
    this.buttonAcces = this.accesoOpcionesService.getObtieneOpciones('app-ven-panel-ov-detallado-direccion-despacho');
  }
