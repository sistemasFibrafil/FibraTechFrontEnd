...
@Component({
  selector: 'app-ven-panel-sodimac-detallado-ean-view',
  templateUrl: './panel-sodimac-detallado-ean-view.component.html',
  styleUrls: ['./panel-sodimac-detallado-ean-view.component.css']
})
export class PanelSodimacDetalladoEanViewComponent implements OnInit {

  // Titulo del componente
  titulo = 'Detallado - Ean';
