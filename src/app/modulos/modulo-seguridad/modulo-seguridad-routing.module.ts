...
const ROUTES: Routes = [
    ...
    { path: 'persona-permiso-logistico/:id',              data: { breadcrumb: 'Permiso Logistico' },  component: PersonaPermisoLogisticoComponent },
    { path: 'persona-configuracion-serie-documento/:id',  data: { breadcrumb: 'Configuración Serie Documento' }, component: PersonaConfigSerieDocumentoComponent },
