...
@Component({
  selector: 'app-bor-panel-documento-borrador-view',
  templateUrl: './panel-documento-borrador-view.component.html',
  styleUrls: ['./panel-documento-borrador-view.component.css']
})
export class PanelDocumentoBorradorViewComponent implements OnInit, OnDestroy {
