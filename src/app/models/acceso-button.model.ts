export class ButtonAcces {
    ...
    btnAsignar                      : boolean;
    btnImprimir                     : boolean;
    btnImprimirPickingList          : boolean;
    ...
    btnAgregar                      : boolean;
    btnEnviar                       : boolean;
    btnPermisoLogistico             : boolean;
    btnVehiculo                     : boolean;
    btnConductor                    : boolean;

    constructor() {
        this.btnNuevo               = true;
        this.btnLiberar             = true;
        this.btnEditar              = true;
        ...
        this.btnImprimirPickingList = true;
        ...
        this.btnEnviar              = true;
        this.btnPermisoLogistico    = true;
        this.btnVehiculo            = true;
